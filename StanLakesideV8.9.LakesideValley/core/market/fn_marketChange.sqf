...
/*
	...
	NOTE: increase in random number above to make all events less frequently!
...
switch(true) do
{
	...
	{
		[[0,"News: Interpol has an international drug gang excavated!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Oil tanker sank in the ocean!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: New synthetic drug inundated drug market!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
